...
| Symptom | Fix |
|---------|-----|
| "Unsupported Java version" | Upgrade to **Java 21+** — see [Requirements]({{ site.baseurl }}/requirements/) |
...
| Wrong group weight | Set higher [weight]({{ site.baseurl }}/concepts/weight/) on the group whose prefix should show |
...
See [Migration FAQ]({{ site.baseurl }}/faq/migration/).
