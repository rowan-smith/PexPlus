...
Install the universal **`PermissionsExPlus-1.23.5.jar`** on each server process (backend and proxy).

## Java

**Java 21 or newer** is required to run PermissionsExPlus 1.23.5.
...
Keep a single `PermissionsExPlus-1.23.5.jar`.
