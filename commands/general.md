...
Disable the same way. Use when diagnosing [permission issues]({{ site.baseurl }}/guides/troubleshooting/).
...
These work without the `/pex` prefix. See [Rank commands]({{ site.baseurl }}/commands/ranks/).
