...
See [Context & Worlds](/concepts/context/).
...
| Forgetting the `default` group | Set one group as [default](/faq/default-groups/) |
...
- [Group commands](/commands/groups/) — `parents add/set/remove`
- [User commands](/commands/users/) — `group add/set/remove`
