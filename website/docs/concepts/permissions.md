...
3. **Inherited group permissions** — from parent groups up the [inheritance](/concepts/inheritance/) chain
4. **World-scoped overrides** — if checking in a specific [context](/concepts/context/)
...
See [Permission commands](/commands/permissions/) for how to assign nodes.
