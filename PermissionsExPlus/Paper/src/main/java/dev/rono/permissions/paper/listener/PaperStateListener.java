...
public final class PaperStateListener implements Listener {
    private final CoreStateTracker tracker;

    private final Consumer<Player> refreshPermissions;

    public PaperStateListener(CoreStateTracker tracker, Consumer<Player> refreshPermissions) {
    ...
    public void onGameModeChange(PlayerGameModeChangeEvent event) {
        ...
        tracker.updateState(player.getUniqueId(), "gamemode",
                event.getNewGameMode().name().toLowerCase(Locale.ROOT));
